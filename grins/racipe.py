...
def mc_param_gen(numCores, sim_save_dir, num_replicates, num_params, num_init_conds, sampling_method, topo_files):
...
def main():
    ...
    parser.add_argument('--outdir', type=str, help='simulation directory', default='SimulResults')
    ...
    parser.add_argument('--num_cores', type=int, help='number of cores for parameter generation', default=None)
    parser.add_argument('--sampling', type=str, help="sampling method. Choices: 'Sobol', 'LHS', 'Uniform', 'LogUniform', 'Normal', 'LogNormal'.", default='Sobol')
    ...
    mc_param_gen(args.num_cores, args.outdir, args.num_reps, args.num_paras, args.num_inits, args.sampling, topos)
